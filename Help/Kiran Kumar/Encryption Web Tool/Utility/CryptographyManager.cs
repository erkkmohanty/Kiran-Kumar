...
namespace XtraPower.Utility
{
    public class CryptographyManager
    {
        private byte[] _keyByte = { };
        //Default Key
        private static string _key = "IOCL&V3r!f0n3+C0mM$3L";
        ...
        public string Encrypt(string value, string key, string iv)
        {
            ...
            if (!string.IsNullOrEmpty(value))
            {
                ...
                {
                    log.Error("Encrypt:: Message: " + ex.Message + " StackTrace: " + ex.StackTrace + " InnerException: " + ex.InnerException + " Source: " + ex.Source);
                }
                finally
                {
                    cs.Dispose();
        ...
        public string Decrypt(string value, string key, string iv)
        {
            ...
            if (!string.IsNullOrEmpty(value))
            {
                ...
                {
                    log.Error("Decrypt:: Message: " + ex.Message + " StackTrace: " + ex.StackTrace + " InnerException: " + ex.InnerException + " Source: " + ex.Source);
                }
                finally
                {
                    cs.Dispose();
        ...
        public string ComputeHash(string salt, HashName hashName)
        {
            //if (!string.IsNullOrEmpty(plainText))
            //{
            // Convert plain text into a byte array. 
            ...
            if (!string.IsNullOrEmpty(salt))
            {
                ...
                plainTextWithSaltBytes = new byte[saltBytes.Length];
            }
            else
            {
                // Define min and max salt sizes. 
