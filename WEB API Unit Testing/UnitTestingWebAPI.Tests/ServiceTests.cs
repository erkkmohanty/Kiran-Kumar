...
namespace UnitTestingWebAPI.Tests
{
    ...
    public class ServiceTests
    {
        ...
        public void ServiceShouldAddNewArticle()
        {
            ...
            int _maxArticleIDBeforeAdd = _randomArticles.Max(article => article.ID);
        ...
        public void ServiceShouldUpdateArticle()
        {
            ...
            _firstArticle.Title = "OData feat. ASP.NET Web API"; // reversed<img width="16" height="16" class="wp-smiley emoji" draggable="false" alt=":-)" src="https://s1.wp.com/wp-content/mu-plugins/wpcom-smileys/simple-smile.svg" style="height: 1em; max-height: 1em;">
